...
const overrides = new Map([
  ...
  ["src/features/messages/hooks.ts", 515], // message query/mutation hooks + optimistic updates + custom-emoji reaction URL resolution (reactionEmojiUrl from cached relay set)
