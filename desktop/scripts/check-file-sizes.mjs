...
const overrides = new Map([
  ...
  ["src/features/sidebar/ui/CustomChannelSection.tsx", 545], // ChannelGroupSection + CustomChannelSection + SectionHeaderActions + ChannelContextMenuItems + MoveToSectionSubmenu
