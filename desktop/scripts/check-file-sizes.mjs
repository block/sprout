...
const overrides = new Map([
  ...
  ["src/features/sidebar/ui/AppSidebar.tsx", 785], // channels + forums creation forms + Pulse nav + channel sections state/dialogs
  ["src/features/sidebar/ui/CustomChannelSection.tsx", 565], // ChannelGroupSection + CustomChannelSection + SectionHeaderActions + ChannelContextMenuItems + MoveToSectionSubmenu + per-section mark-all-read
