...
const overrides = new Map([
  ...
  ["src-tauri/src/nostr_convert.rs", 1170], // 12 Nostr event→model converters (channels, profiles, members, notes, search, agents, relay members) + filter_and_rank_user_search ranker (latest-kind:0-dedupe before mirroring sprout-db ORDER BY) + 31 unit tests
