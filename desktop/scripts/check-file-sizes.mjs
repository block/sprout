...
const overrides = new Map([
  ...
  ["src-tauri/src/migration.rs", 610], // worktree shared-agent-data sync (SHARED_AGENT_FILES copy-with-overwrite + runtime_pid scrub) + mcp_command provider reconciliation + tests
