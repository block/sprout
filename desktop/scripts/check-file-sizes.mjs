...
const overrides = new Map([
  ...
  ["src-tauri/src/migration.rs", 900], // worktree shared-agent-data symlink sync (SHARED_AGENT_FILES + SHARED_AGENT_DIRS symlink-to-canonical) + mcp_command provider reconciliation + persona_pack_path reconciliation + tests
