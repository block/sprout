...
| `SPROUT_AGENT_MAX_TOOL_RESULT_TEXT_BYTES` | `51200` | 50 KiB. Per-result cap on tool-output text; oversize is middle-elided (head + tail kept) with an inline marker. Images are exempt. |
...
| Tool result text | 50 KiB | `SPROUT_AGENT_MAX_TOOL_RESULT_TEXT_BYTES` |
